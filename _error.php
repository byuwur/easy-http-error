...
<body>
	...
	<div class="message-box">
		...
		<a id="mateus_link" href="<?= $mateus_link; ?>">[Mateus] byUwUr</a>
		<span>ERROR</span>
		<h1 id="e"><?= $_GET["e"]; ?></h1>
		<p id="estringes"><?= $_estringes; ?></p>
		<p id="estringen"><?= $_estringen; ?></p>
		<br>
		<span id="emessage"><?= $_emessage; ?></span>
		<span id="sorry"><?= $_sorry; ?></span>
		<div class="action-link-wrap">
			<a id="back_button" onclick="history.back(-1)"><?= $_back; ?></a>
			<a id="out_button" href="./"><?= $_out; ?></a>
		</div>
		<span id="custom_error_message"><?= isset($_POST["custom_error_message"]) ? "System error:<br>" . $_POST["custom_error_message"] : ""; ?></span>
	</div>
</body>
